export class Score {
    constructor(p5) {
        ...
        this.playerOneName = "JohnDoe"; // Nombre del jugador 1
        this.playerOneScore = 2000; // Puntuación de jugador 1
        this.playerTwoName = "Pepe Ganga"; // Nombre del jugador 2
        this.playerTwoScore = 1500; // Puntuación de jugador 2
    ...
    show(p5) {
        ...
        const centerY = p5.height / 7;
        const titleY = 50; // Ajusta la posición vertical del título
        ...
        p5.text(this.playerOneName, centerX, firstLineY);
        ...
        p5.text(this.playerOneScore + " pts", centerX + 140, firstLineY);
